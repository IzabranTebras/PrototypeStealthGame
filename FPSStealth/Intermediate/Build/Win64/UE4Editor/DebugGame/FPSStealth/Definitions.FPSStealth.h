...
#define ORIGINAL_FILE_NAME "UE4Editor-FPSStealth-Win64-DebugGame.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_PROJECT_NAME FPSStealth
...
#define FPSSTEALTH_API DLLEXPORT
